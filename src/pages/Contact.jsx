          ...
          <ul className="contact-links">
            ...
            <li>
              <a
                ...
                className="contact-link-row"
              >
                <span className="contact-link-icon contact-link-icon--youtube">
                  <IconYouTube />
                </span>
                <span className="contact-link-info">
                  <span className="contact-link-platform">YouTube</span>
                  <span className="contact-link-handle">@maplestreetband</span>
                </span>
                <span className="contact-link-arrow" aria-hidden="true">
                  ↗
                </span>
            ...
            <li>
              <a
                ...
                className="contact-link-row"
              >
                <span className="contact-link-icon contact-link-icon--tiktok">
                  <IconTikTok />
                </span>
                <span className="contact-link-info">
                  <span className="contact-link-platform">TikTok</span>
                  <span className="contact-link-handle">
                    @themaplestreetband
                  </span>
                </span>
